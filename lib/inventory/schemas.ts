...
export const INVENTORY_FIELDS: Record<InventoryType, FieldSpec[]> = {
  ...
  accommodation: [
    ...
    { key: "tier", label: "Tier", type: "select", options: ["standard", "exclusive", "family", "africamps", "farmhouse", "custom"] },
    { key: "sleeps", label: "Sleeps", type: "number" },
    { key: "ideal_sleeps", label: "Ideal sleeps", type: "number" },
    { key: "max_sleeps", label: "Max sleeps", type: "number" },
    { key: "bridal_suite", label: "Bridal suite?", type: "select", options: ["false", "true"] },
    { key: "cost_treatment", label: "Included or Extra?", type: "select", options: ["included", "extra"], required: true },
    { key: "price_per_night", label: "Price / night (R)", type: "number" },
    { key: "description", label: "Description", type: "string" },
    { key: "amenities", label: "Amenities (comma-separated)", type: "string" },
    ...
    { key: "commission_type", label: "Commission type", type: "select", options: ["fixed", "percent"] },
    { key: "commission_value", label: "Commission (R or %)", type: "number" },
    { key: "hero_image_url", label: "Hero image URL", type: "string" },
    { key: "floor_plan_url", label: "Floor plan URL", type: "string" },
    { key: "image_url", label: "Image URL", type: "string" },
  ],
